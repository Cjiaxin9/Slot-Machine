  ...
  if (
    ...
    if (parseFloat(currentbalance) > parseFloat(currentBet)) {
      ...
      setTimeout(function () {
        ...
        displayForBox1.innerText = items[Math.floor(Math.random() * 2)];
        displayForBox2.innerText = items[Math.floor(Math.random() * 2)];
        displayForBox3.innerText = items[Math.floor(Math.random() * 2)];
        displayForBox4.innerText = items[Math.floor(Math.random() * 2)];
        displayForBox5.innerText = items[Math.floor(Math.random() * 2)];
        displayForBox6.innerText = items[Math.floor(Math.random() * 2)];
        displayForBox7.innerText = items[Math.floor(Math.random() * 2)];
        displayForBox8.innerText = items[Math.floor(Math.random() * 2)];
        displayForBox9.innerText = items[Math.floor(Math.random() * 2)];
